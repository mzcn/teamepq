<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">新建工作系数</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="category_form" name="category_form" method="post" action="/params/add">
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-8">
                                            ...
                                            <div class="col-md-3">
                                                <input id="value" name="value" maxlength="100" class="form-control">
