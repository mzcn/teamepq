        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="user_form" name="user_form" method="post" action="/users/edit">
                                <div class="form-group">
                                    <label>用户名</label>
                                    <input id="username" name="username" maxlength="100" class="form-control"
                                           value="<?php echo $user['users']['username'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="role_id" name="role_id" class="form-control">
                                        ...
                                        <option id="<?php echo $item['roles']['id'];?>"
                                                value="<?php echo $item['roles']['id'];?>"
                                        <?php if($user['users']['role_id'] == $item['roles']['id']) echo 'selected'; ?>
                                        ><?php echo $item['roles']['name'];?></option>
                                        <?php } ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="group_id" name="group_id" class="form-control">
                                        ...
                                        <option id="<?php echo $item['groups']['id'];?>"
                                                value="<?php echo $item['groups']['id'];?>"
                                        <?php if($user['users']['group_id'] == $item['groups']['id']) echo 'selected'; ?>
                                        >
                                        <?php echo $item['groups']['name'];?>
                                        </option>
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" id="is_leader" name="is_leader"
                                           value="1" <?php if($user['users']['is_leader'] == '1') echo 'checked'; ?> />
                                </div>

                                <input type="hidden" id="id" name="id" value="<?php echo $user['users']['id'] ?>"/>
